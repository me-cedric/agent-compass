...
| `gitlab/`         | `merge_request_templates/default.md`                                             | [pull-requests](../docs/workflows/pull-requests.md)  |
| `questions/`      | `check-questions.mjs`                                                            | [open-questions](../docs/workflows/open-questions.md) |
