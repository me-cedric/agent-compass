...
Operational playbooks. Each is a sequence an agent (or you) can follow end to end.
...
| [releasing.md](releasing.md)                   | Tagging a reviewed agent-compass release; attaching host build artifacts. |
